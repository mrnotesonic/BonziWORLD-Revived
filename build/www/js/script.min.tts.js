...
function loadBonzis(a) {
    loadQueue.loadManifest([
        { id: "bonziBlack", src: "./img/bonzi/black.gif" },
        { id: "bonziBlue", src: "./img/bonzi/blue.gif" },
        { id: "bonziBrown", src: "./img/bonzi/brown.gif" },
        { id: "bright_blue", src: "./img/bonzi/bright_blue.gif" },
        { id: "bright_brown", src: "./img/bonzi/bright_brown.gif" },
        { id: "bonziPeedy", src: "./img/bonzi/peedy.gif" },
        { id: "robby", src: "./img/bonzi/robby.gif" },
        { id: "bonziMax", src: "./img/bonzi/max.gif" },
        { id: "bonziGreen", src: "./img/bonzi/green.gif" },
        { id: "bright_green", src: "./img/bonzi/bright_green.gif" },
        { id: "owner", src: "./img/bonzi/owner.gif" },
        { id: "bonziPurple", src: "./img/bonzi/purple.gif" },
        { id: "bonziCyan", src: "./img/bonzi/cyan.gif" },
        { id: "bright_purple", src: "./img/bonzi/bright_purple.gif" },
        { id: "bright_cyan", src: "./img/bonzi/bright_cyan.gif" },
        { id: "clippy", src: "./img/bonzi/clippy.gif" },
        { id: "merlin", src: "./img/bonzi/merlin.gif" },
        { id: "genie", src: "./img/bonzi/genie.gif" },
        { id: "clippypope", src: "./img/bonzi/clippypope.gif" },
        { id: "bruh", src: "./img/bonzi/bruh.gif" },
        { id: "robot", src: "./img/bonzi/robot.gif" },
        { id: "diogo", src: "./img/bonzi/diogo.gif" },
        { id: "soldier", src: "./img/bonzi/soldier.gif" },
        { id: "diogo2", src: "./img/bonzi/diogo2.gif" },
        { id: "program", src: "./img/bonzi/program.gif" },
        { id: "dogpope", src: "./img/bonzi/dogpope.gif" },
        { id: "god", src: "./img/bonzi/god.gif" },
        { id: "redclippy", src: "./img/bonzi/red_clippy.gif" },
        { id: "rover", src: "./img/bonzi/rover.gif" },
        { id: "bonziGrey", src: "./img/bonzi/grey.gif" },
        { id: "bonziRed", src: "./img/bonzi/red.gif" },
        { id: "bright_red", src: "./img/bonzi/bright_red.gif" },
        { id: "bonziPink", src: "./img/bonzi/pink.gif" },
        { id: "bonziYellow", src: "./img/bonzi/yellow.gif" },
        { id: "bright_yellow", src: "./img/bonzi/yellow.gif" },
        { id: "bonziYellow", src: "./img/bonzi/yellow.gif" },
        { id: "bonziDunce", src: "./img/bonzi/dunce.gif" },
        { id: "kiddie", src: "./img/bonzi/shitsky.gif" },
        { id: "bonziOrange", src: "./img/bonzi/orange.gif" },
        { id: "bonziWhite", src: "./img/bonzi/white.gif" },
        { id: "bonziDarkPurple", src: "./img/bonzi/dark_purple.gif" },
        { id: "bonziGlitch", src: "./img/bonzi/glitch.gif" },
        { id: "bonziRainbow", src: "./img/bonzi/rainbow.gif" },
        { id: "bonziAux", src: "./img/bonzi/glitchy.gif" },
        { id: "bonziNul", src: "./img/bonzi/buggiest.gif" },
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", speed: 175, pitch: 50, sapi5pitch: 1, amplitude: 100, voice: "Adult Male #2, American English (TruVoice)" }),
            ...
            (this.x = e.x * this.rng()),
                ...
                setTimeout(function () {
                    if (d.color != "clippy" && d.color != "peedy" && d.color != "robby" && d.color != "merlin" && d.color != "genie" && d.color != "rover" && d.color != "losky" && d.color != "max") {
                        if (d.color == "diogo") {
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    key: "backflip",
                    value: function (a) {
                        var b = [{ type: "anim", anim: "backflip", ticks: 30 }];
                        a && (b.push({ type: "anim", anim: "cool_fwd", ticks: 40 }), b.push({ type: "idle" })), this.runSingleEvent(b);
                    },
                },
                {
                    key: "clap",
                ...
                },
                {
                    key: "clap_clippy",
                    value: function () {
                        var a = [{ type: "anim", anim: "clap_clippy_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "sad",
                    value: function () {
                        var a = [{ type: "anim", anim: "sad_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "think",
                    value: function () {
                        var a = [{ type: "anim", anim: "think_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "wave",
                    value: function () {
                        var a = [{ type: "anim", anim: "wave", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "nod",
                    value: function () {
                        var a = [{ type: "anim", anim: "nod", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                ...
                },
                {
                    key: "banana",
                    value: function () {
                        var a = [{ type: "anim", anim: "banana_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "surprised",
                    value: function () {
                        var a = [{ type: "anim", anim: "surprised_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "laugh",
                    value: function () {
                        var a = [{ type: "anim", anim: "laugh_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                ...
                },
                {
                    key: "write",
                    value: function () {
                        var a = [{ type: "anim", anim: "write_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "write2",
                    value: function () {
                        var a = [{ type: "anim", anim: "write_once_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "write3",
                    value: function () {
                        var a = [{ type: "anim", anim: "write_infinite_fwd", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                ...
                },
                {
                    key: "confused",
                    value: function () {
                        var a = [{ type: "anim", anim: "confused_fwd", ticks: 40 }];
                        this.runSingleEvent(a);
                ...
                },
                {
                    key: "surfjoin",
                    value: function () {
                        var a = [{ type: "anim", anim: "surf_intro_emote", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                    key: "surfleave",
                    value: function () {
                        var a = [{ type: "anim", anim: "surf_away_emote", ticks: 30 }];
                        this.runSingleEvent(a);
                    },
                },
                {
                ...
                },
                {
                    key: "asshole",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "You're a fucking asshole!", say: "your a fucking asshole!" }, { type: "anim", anim: "grin_fwd", ticks: 25 }, { type: "idle" }]);
                    },
                },
                {
                    key: "beggar",
    ...
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [
                ...
                { type: "text", text: "SHIT CUZ FUCK JS RAIDS!!1", say: "shit cuz fuck j s raids!" },
                { type: "text", text: "Shut the fuck up about my humor, it's da best.", say: "shut the fuck up about my humor, it's the best." },
                { type: "anim", anim: "shrug_back", ticks: 15 },
                { type: "text", text: "Hopefully none of these script kiddies get mad. which none of them did, so it does not trigger their anger." },
            ...
            [
                ...
                { type: "text", text: "Me!", say: "\\Pit=400\\ Me!" },
            ],
            [
            ...
            [
                ...
                { type: "text", text: "Grow a another watermelon." },
            ],
        ...
        event_list_fact_end: [
            [{ type: "text", text: "Pretty cool huh?" }],
            [{ type: "text", text: "This is a very popular fact! According to Bonzi.COM.", say: "This is a very popular fact! According to Bonzi dot com." }],
            [{ type: "text", text: "Did you also know that Max Alert is also going to be in BonziWORLD Revived?" }],
            [{ type: "text", text: "Reminder: You cannot have pope, god, or diogo's color. Only people who have the godmode password can change the color to those." }],
            [{ type: "text", text: "Oh gee whilickers! Wasn't that sure intresting, huh?" }],
            [{ type: "text", text: "Did you also know that you can do /uwu as a alternative to noticing BonziBulges™?" }],
            [{ type: "text", text: "Did you also know that Microsoft Edge provides world-class performance with more privacy, more productivity, and more value while you browse? What are you waiting for!? " }],
            [{ type: "text", text: "Did you also know that BonziWORLD is harmless? Even if it has 'Malwaresoft' in the logo, doesn't mean it is a virus. BonziBUDDY is a virus, adware, spyware, and you shouldn't download it." }],
        ],
    };
