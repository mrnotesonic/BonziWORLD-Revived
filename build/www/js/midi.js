! function(e) {
    ...
    function o(e, n, t) {
        ...
        o.open("GET", n + t, !0), o.responseType = "arraybuffer", o.onerror = function() {
            ...
            if (F--, FS.createDataFile("pat/", t, new Int8Array(o.response), !0, !0), MIDIjs.message_callback && F > 0 && MIDIjs.message_callback("Instruments to be loaded: " + F), A("Instruments to be loaded: " + F), 0 == F) {
                ...
                Module.ccall("mid_song_start", "void", ["number"], [W]), V = S.createScriptProcessor(R, 0, 1), O = Module._malloc(2 * R), V.onaudioprocess = r, V.connect(S.destination), P = setInterval(i, J), MIDIjs.message_callback && MIDIjs.message_callback("Playing: " + e), A("Playing: " + e + " ...")
            }
        }, o.send()
    }
    ...
    function u() {
        return S ? S.resume() : (window.AudioContext = window.AudioContext || window.webkitAudioContext, S = new AudioContext, S.resume())
    }
    ...
    function m(e, n, t) {
        ...
        A("Loading MIDI file " + e + " ..."), t || MIDIjs.message_callback("Loading MIDI file " + e + " ...");
    ...
    function f(e, n, t) {
        ...
        if (W = Module.ccall("mid_song_load", "number", ["number", "number"], [a, u]), rval = Module.ccall("mid_istream_close", "number", ["number"], [a]), F = Module.ccall("mid_song_get_num_missing_instruments", "number", ["number"], [W]), 0 < F)
            for (var l = 0; l < F; l++) {
                ...
                o(e, q + "pat/", c)
            } else Module.ccall("mid_song_start", "void", ["number"], [W]), V = S.createScriptProcessor(R, 0, 1), O = Module._malloc(2 * R), V.onaudioprocess = r, V.connect(S.destination), P = setInterval(i, J), MIDIjs.message_callback && MIDIjs.message_callback("Playing: " + e), A("Playing: " + e + " ...")
    }
    ...
    try {
        ...
        e.MIDIjs.set_logging = function(e) {
            ...
            return U
        }, e.MIDIjs.player_callback = function(e) {}, e.MIDIjs.message_callback = function(e) {
            if (e.startsWith('Playing:')) {
                MIDIjs.get_duration(midiFile, 
                    function(seconds) { 
        ...
        }, 1), -1 == location.href.indexOf("scorio.com") && -1 == location.href.indexOf("weblily.net") && -1 == location.href.indexOf("local") || "WebAudioAPI" == C && (a(q + "pat/arachno-127.pat"), a(q + "pat/MT32Drums/mt32drum-41.pat"), a(k)), e.MIDIjs.initError = null
    } catch (Z) {
